  ...
  return (
    <div className="max-h-44 rounded-md border bg-gray-200 border-gray-600">
      <button
        ...
        hover:opacity-80 
        ${flipped && toAnimate ? `animate-flip` : `animate-flipback`}
      ...
      >
        ...
        {!animating && !flipped && (
          <div className="h-full w-full rounded-t-md bg-tertiary overflow-clip">
            {frontside}
          </div>
        )}
        ...
        {!animating && flipped && (
          <div className="h-full w-full rounded-t-md bg-quinary borderoverflow-clip">
            {backside}
          </div>
        )}
      </button>
      {editable && (
        <div className="">
          <button className="w-full rounded-b-md" onClick={(e) => {}}>
            edit
          </button>
        </div>
      )}
