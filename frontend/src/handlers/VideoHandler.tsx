...
export const fetchVideos = async (setVideos: React.Dispatch<React.SetStateAction<VideoDto[]>>) => {
    try {
...
export const handleDeleteVideo = async (
    id: string,
    fetchVideos: (setVideos: React.Dispatch<React.SetStateAction<VideoDto[]>>) => Promise<void>,
