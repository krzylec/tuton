...
} from "../../handlers/FlashcardHandler";
...
export default function AdminView() {
  const emptyFlashcardDto: FlashcardDto = {
    id: 0,
    frontText: "",
    backText: "",
    lessonId: 1,
    ...
    <div>
                ...
                flashcard.id === editRow ? (
                  ...
                  <>
                    ...
                    <Button
                      text="delete"
                      onClick={() =>
                        handleDeleteFlashcard(flashcard, setFlashcards)
                      }
                    />
                  </>
                ) : (
      ...
      <div className="flex flex-row p-2 space-x-1">
        ...
        <Input
          ...
          onChange={(e) =>
            setNewFlashcard({ ...newFlashcard, frontText: e.target.value })
          }
        />
        <Label text="backtext:" />
        <Input
          ...
          onChange={(e) =>
            setNewFlashcard({ ...newFlashcard, backText: e.target.value })
          }
        />
        <Label text="lessonId:" />
        <Select
        ...
        />
        <Button text="Create flashcard" onClick={() => handleCreateOnClick()} />
      </div>
    </div>
  );
}
